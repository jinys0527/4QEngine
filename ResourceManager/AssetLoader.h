...
public:
	...
	ShaderHandle    ResolveShader(const std::string& assetMetaPath, UINT32 index) const;
	...
	bool GetShaderAssetReference(ShaderHandle handle, std::string& outPath, UINT32& outIndex) const;
	...
	ResourceStore<RenderData::ShaderData, ShaderHandle>& GetShaders() { return m_Shaders; }
...
private:
	...
	ResourceStore<RenderData::ShaderData, ShaderHandle>       m_Shaders;
	...
	std::unordered_map<uint64_t, ShaderRef>			 m_ShaderRefs;
